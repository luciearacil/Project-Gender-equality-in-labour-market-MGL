...
gganimate_1 <- ggplot(data = PC_Act_Gapbis, aes(x=values, y=gap, color=country)) +
  ...
  labs(title="Correlation between the activity rate and the activity rate gap in 2006, 2010 and 2018 for all European countries") +
...
ggplot(data = PC_GDP_Gap, aes(x=values/100, y=gap, color=country)) +
  ...
  facet_wrap(~time) +
  labs(title="Correlation between the activity rate gap and the GDP in 2006, 2010 and 2018 for all European countries") + xlab("GDP in ") +
...
ggplot(mapdatapartimeF, aes(x = long, y = lat, group = group))+
  ...
  labs(title="Woman Part-time employement throughout Europe, 2017",
