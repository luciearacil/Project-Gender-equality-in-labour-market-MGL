...
min2018=min(PC_Act_F2018$PC_act) # Turquie 
PC_Act_F2018%>%filter(PC_act==min2018)%>%select(CNTR_CODE)
...
# Find the country with the lowest woman activity  in Europe  
 PC_Act_FUE=PC_Act_F2018 %>% 
  filter(! CNTR_CODE %in% c("EA17","EA18","EA19","EU15","EU28","TR","MK"))%>% filter(sex=="F")
min2018UE=min(PC_Act_FUE$PC_act)
PC_Act_F2018%>%filter(PC_act==min2018UE)%>%select(CNTR_CODE)
       
# Find the country with the higher woman activity rate  
max2018=max(PC_Act_F2018$PC_act) # Sweden
PC_Act_F2018%>%filter(PC_act==max2018)%>%select(CNTR_CODE)
