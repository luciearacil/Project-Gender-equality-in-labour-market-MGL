...
betaslope1<-coef(betaslope1)[2]  ### voir pour arrondir
print(betaslope1)
...
gganimate_10 <- ggplot(data = Corrbirth, aes(x=values, y=PC_parttime_onemp, color=country)) +
  ...
  labs(title = 'time: {frame_time}', x = 'time', y = 'PC_parttime_onemp')
